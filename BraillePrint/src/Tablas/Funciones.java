...
public class Funciones extends javax.swing.JFrame {
    ...
    public Funciones() {
        ...
        t = new ArrayList();
        t.add(new Object[]{"func_CalCad"});
        t.add(new Object[]{"func_Ver"});
        t.add(new Object[]{"func_ContCarac"});
        t.add(new Object[]{"func_Imprimir"});
        llenarTabla();
    }
    ...
    {
        dtm.setColumnIdentifiers(new Object[] {"Funciones"});
        t.forEach((token) -> {
            dtm.addRow(token);
        });
    }
